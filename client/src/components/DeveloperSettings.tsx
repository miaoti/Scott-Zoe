        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-apple-separator rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400"
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-purple-400 text-white py-2 px-4 rounded-lg hover:bg-purple-500 disabled:opacity-50 transition-colors"
          >
            ...
            <div className="border-b border-apple-separator pb-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  disabled={loading}
                  className="bg-purple-400 text-white px-4 py-2 rounded-lg hover:bg-purple-500 disabled:opacity-50 transition-colors flex items-center"
                >
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        className="flex-1 px-3 py-2 border border-apple-separator rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400"
                        placeholder="New count"
                      />
                      <button
                        onClick={() => updateOpportunities('scott')}
                        disabled={loading}
                        className="bg-purple-400 text-white px-3 py-2 rounded-lg hover:bg-purple-500 disabled:opacity-50 transition-colors flex items-center"
                      >
