...
function Header() {
  ...
  const fetchRelationshipInfo = useCallback(async () => {
    try {
      const response = await api.get('/auth/relationship-info');
        ...
        <div className="flex items-center justify-between h-16">
          ...
          {relationshipInfo && (
            <div className="relative hidden md:block">
              ...
              {showDropdown && (
                <div className="absolute top-full right-0 mt-2 apple-glass-background rounded-xl p-4 apple-shadow border border-apple-separator min-w-[200px] z-50">
        ...
        {relationshipInfo && (
          <div className="md:hidden pb-4 text-center">
            <div className="relative inline-block">
              ...
              {showDropdown && (
                <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 apple-glass-background rounded-xl p-4 apple-shadow border border-apple-separator min-w-[200px] z-50">
                  <div className="text-center">
                    <div className="text-2xl font-semibold text-apple-blue-light mb-1">
                      {relationshipInfo.daysTogether}
                    </div>
