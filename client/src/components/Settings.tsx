...
import { Heart, ArrowLeft, Trophy, Gift, User, Settings as SettingsIcon, ChevronDown, ChevronRight, Calendar, BarChart3, Cog } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-apple-secondary-background">
      <div className="max-w-2xl mx-auto px-6 py-8">
        ...
        <div className="apple-card apple-shadow overflow-hidden">
          <button
          ...
          >
            ...
            <div className="transition-transform duration-200">
              {expandedSections.relationship ? (
                <ChevronDown className="h-5 w-5 text-apple-secondary-label" />
              ) : (
                <ChevronRight className="h-5 w-5 text-apple-secondary-label" />
              )}
            </div>
          </button>
            ...
            <div className="px-6 pb-6">
              <div className="bg-apple-blue/5 border border-apple-blue/20 rounded-xl p-6">
                <div className="text-center">
                  ...
                  <div className="text-apple-secondary-label mb-3">
        ...
        <div className="mt-6">
          <div className="apple-card apple-shadow overflow-hidden">
            ...
            >
              <div className="flex items-center">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-apple-secondary-label">
                    Personal statistics and opportunities
                  </p>
                </div>
              </div>
              <div className="transition-transform duration-200">
            ...
            <div className={`transition-all duration-300 ease-in-out overflow-hidden ${
              expandedSections.stats ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'
            }`}>
              <div className="px-6 pb-6">
                {loadingUserData ? (
        ...
        <div className="mt-6">
          <div className="apple-card apple-shadow overflow-hidden">
            <button
              onClick={() => toggleSection('prizeHistory')}
              className="w-full p-6 flex items-center justify-between hover:bg-apple-gray-6/5 transition-colors duration-200"
            >
              <div className="flex items-center">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-apple-secondary-label">
                    {prizeStats.totalPrizes} prizes won • Total value: {prizeStats.totalValue}
                  </p>
                </div>
              </div>
              <div className="transition-transform duration-200">
                {expandedSections.prizeHistory ? (
                  <ChevronDown className="h-5 w-5 text-apple-secondary-label" />
                ) : (
                  <ChevronRight className="h-5 w-5 text-apple-secondary-label" />
                )}
            ...
            <div className={`transition-all duration-300 ease-in-out overflow-hidden ${
              expandedSections.prizeHistory ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'
            }`}>
              <div className="px-6 pb-6">
                {/* Prize Stats */}
        ...
        <div className="mt-6">
          <div className="apple-card apple-shadow overflow-hidden">
            <button
              onClick={() => toggleSection('wheelConfig')}
              className="w-full p-6 flex items-center justify-between hover:bg-apple-gray-6/5 transition-colors duration-200"
            >
              <div className="flex items-center">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-apple-secondary-label">
                    Customize {otherUser?.displayName || otherUser?.username || 'your partner'}'s prize wheel
                  </p>
                </div>
              </div>
              <div className="transition-transform duration-200">
                {expandedSections.wheelConfig ? (
                  <ChevronDown className="h-5 w-5 text-apple-secondary-label" />
                ) : (
                  <ChevronRight className="h-5 w-5 text-apple-secondary-label" />
                )}
              ...
              <div className="px-6 pb-6">
                <div className="text-center mb-6">
                  <p className="text-apple-secondary-label">
                    Customize prize wheel settings and adjust winning probabilities
                  </p>
                </div>
